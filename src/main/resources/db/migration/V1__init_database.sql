...
create table if not exists "favorite-exercises"
(
    id            bigint generated by default as identity
    primary key,
    created_by    bigint       not null,
    ...
    modified_date timestamp(6),
    exercise_id   bigint
    constraint fk7b21sr6o9cm9025c2b9sswkic
    references exercises,
    user_id       bigint
    constraint fkjd4y63i4tsn8vsycmlgai73wo
    references users
    );

alter table "favorite-exercises"
    owner to banasiak;
